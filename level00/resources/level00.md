...
When we ran the program, it asked us for a password, and it seemed like there was a structure that determined whether it was correct or incorrect. We then ran it to analyze it with gdb, and as we thought, it was comparing the value entered with **0x149c**. This caused us to quickly pass this level, just like in rainfall level0.
